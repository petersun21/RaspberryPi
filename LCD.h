...
// LCD Commands
// ---------------------------------------------------------------------------
#define LCD_CLEARDISPLAY        0x01  // master
#define LCD_RETURNHOME          0x02  // master

// working in bitwise OR to
#define LCD_ENTRYMODESET        0x04  // master + LCD_ENTRYRIGHT + LCD_ENTRYSHIFTDECREMENT
#define LCD_ENTRYLEFT           0x02
#define LCD_ENTRYSHIFTINCREMENT 0x01


// DISPLAY ON/Off bitise or to combine
#define LCD_DISPLAYCONTROL      0x08  // master + LCD_DISPLAYOFF / LCD_CURSOROFF / LCD_BLINKOFF
#define LCD_DISPLAYON           0x04
#define LCD_CURSORON            0x02
#define LCD_BLINKON             0x01

// combine with bitwise or
#define LCD_CURSORSHIFT         0x10 // master
...
#define LCD_FUNCTIONSET         0x20  // master + 4bits + 1 line + 5x7 dots
...
protected:
   uint8_t _fd;   // file descriptor for wiringPi
